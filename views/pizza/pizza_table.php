<table class="table table-bordered table-striped">
    <tr>
        ...
        <td class="col-sm-2 "><a href="/adminPage/update/<?php echo $pizza->getIdp() ?>" class="btn btn-primary glyphicon glyphicon-refresh dist"> Modifică</a><br>
        <a href="/adminPage/delete/<?php echo $pizza->getIdp() ?>" class="btn btn-primary glyphicon glyphicon-trash"> Șterge</a></td>
    </tr>
</table>